> **Historical baseline document — superseded.** Retained for repository history. Follow [docs/OPENCODE-START-PROMPT.md](docs/OPENCODE-START-PROMPT.md) and [README.md](README.md) for the current contribution-payment MVP. Legacy reputation-score and SDK plans below are not active requirements.
