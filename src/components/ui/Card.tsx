...
export const CardHeader = forwardRef<HTMLDivElement, CardHeaderProps>(
  ({ className, ...props }, ref) => (
    <HeroCardHeader ref={ref} className={className} {...props} />
  )
)

export const CardContent = forwardRef<HTMLDivElement, CardContentProps>(
  ({ className, ...props }, ref) => (
    <HeroCardContent ref={ref} className={className} {...props} />
  )
)

export const CardFooter = forwardRef<HTMLDivElement, CardFooterProps>(
  ({ className, ...props }, ref) => (
    <HeroCardFooter ref={ref} className={className} {...props} />
  )
)

export const CardTitle = forwardRef<HTMLDivElement, CardTitleProps>(
  ({ className, ...props }, ref) => (
    <HeroCardTitle ref={ref} className={className} {...props} />
  )
)
