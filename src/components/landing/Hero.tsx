  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <div className="orb orb-left-1" />
        <div className="orb orb-left-2" />
        <div className="orb orb-right-1" />
      </div>
      ...
      <style jsx>{`
        ...
        .orb-left-1 {
          ...
          animation: floatLeft1 25s ease-in-out infinite;
        }
        .orb-left-2 {
          width: 500px;
          height: 500px;
          background: radial-gradient(circle at 70% 70%, var(--primary) 0%, transparent 70%);
          animation: floatLeft2 30s ease-in-out infinite reverse;
        }
        .orb-right-1 {
          width: 400px;
          height: 400px;
        ...
        @keyframes floatLeft1 {
          0%, 100% { transform: translate(-150px, -100px) scale(1); }
          14% { transform: translate(-50px, -180px) scale(1.1); }
          28% { transform: translate(-200px, 20px) scale(0.95); }
          42% { transform: translate(-80px, -60px) scale(1.05); }
          56% { transform: translate(-180px, 80px) scale(0.9); }
          70% { transform: translate(-20px, -120px) scale(1.08); }
          84% { transform: translate(-120px, 140px) scale(1.02); }
        }
        @keyframes floatLeft2 {
          0%, 100% { transform: translate(-80px, 60px) scale(1); }
          11% { transform: translate(-200px, -40px) scale(1.15); }
          22% { transform: translate(-30px, 160px) scale(0.9); }
          33% { transform: translate(-160px, -100px) scale(1.08); }
          44% { transform: translate(-40px, 180px) scale(1.0); }
          55% { transform: translate(-180px, 20px) scale(0.95); }
          66% { transform: translate(-100px, -140px) scale(1.1); }
          77% { transform: translate(-60px, 80px) scale(1.05); }
          88% { transform: translate(-140px, -20px) scale(1.0); }
        }
        @keyframes floatRight1 {
          0%, 100% { transform: translate(150px, 80px) scale(1); }
          16% { transform: translate(250px, -40px) scale(1.2); }
          32% { transform: translate(80px, 180px) scale(0.85); }
          48% { transform: translate(200px, 140px) scale(1.1); }
          64% { transform: translate(40px, 60px) scale(0.9); }
          80% { transform: translate(280px, 100px) scale(1.05); }
        }
      `}</style>
