...
import { PageShell, PageIntro, Notice, Badge, ActionLink, Button } from '@/components/system';
import { NetworkBanner, ShareButton } from '@/components/forms';
    ...
    return (
      <PageShell>
        ...
        {error ? (
          ...
          <Notice>Loading this profile&hellip;</Notice>
        )}
      </PageShell>
    );
    ...
    <PageShell>
      ...
      <section className="profile-hero">
        ...
        <div className="actions">
          ...
          <ActionLink href={'/acknowledge?to=' + encodeURIComponent(p.handle)} size="sm">
      ...
      <div className="profile-details">
        <aside>
          ...
          {p.bio && <p style={{ marginTop: 'var(--space-6)' }}>{p.bio}</p>}
