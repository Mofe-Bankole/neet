...
export class NeetSDK {
  ...
  private readonly client: NeetClient
  ...
  readonly getIdentity = (handle: string): Promise<IdentityResponse> =>
    this.identity.getIdentity(handle)
